...
export function ExpenditureOversight() {
  ...
  return (
    <View style={styles.container}>
      <Title text="Expenditure Oversight" path="Menu" />

      <View style={styles.tabContainer}>
        <Text style={styles.title}>Select Filters to view expenses</Text>
        <CustomForm
        ...
        <ScrollView>
            ...
            >
              <View>
                ...
                <View style={{ flexDirection: "row" }}>
                  <Text style={styles.invoiceText}>Month</Text>
                  <Text style={styles.invoiceText}>Year</Text>
                </View>
                <View style={{ flexDirection: "row" }}>
          ...
          <InfoTile width={343}>
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <View style={styles.columns}>
                  ...
                  <Text
                    style={{ ...styles.column, width: 40, textAlign: "right" }}
                  >
            ...
            />
            <View style={styles.columns}>
              <Text style={{ ...styles.column, fontWeight: 600 }}>TOTAL</Text>
